...
for run_id, epoch, exec_real, t1_real, bdry_opt in zip(
    RUNS, EPOCHS, EXEC_REALIZED, T1_REAL, BDRY_OPT
):
    ...
    print(
        "{:<12}  {:>7}  {:>14,}  {:>10}  ${:>11.2f}  ${:>11.2f}  ${:>11.2f}  {:>+11.1f}%".format(
            epoch,
            run_id,
            int(actual_votes),
            pools,
